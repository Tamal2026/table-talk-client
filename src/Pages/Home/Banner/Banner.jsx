    ...
    <div className="  relative">
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="w-1/4 p-6 text-center bg-gradient-to-br from-purple-500 to-blue-500 rounded-lg shadow-lg transition duration-300 hover:scale-105 relative overflow-hidden">
          <h2 className="text-2xl font-bold text-white animate__animated animate__fadeIn animate__delay-1s">
            Special Offers
          </h2>
          <p className="text-white mt-2 animate__animated animate__fadeIn animate__delay-2s">
